...
createDeviceFile :: MonadInIO m => Maybe Handle -> FilePath -> Device -> FilePermissions -> Flow '[ErrorCode] m ()
...
sysfsReadDevFile' :: MonadIO m => Handle -> Flow ReadErrors' m DeviceID
