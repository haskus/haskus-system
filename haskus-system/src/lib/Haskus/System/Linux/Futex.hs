...
sysFutex :: MonadIO m => Ptr Int64 -> FutexOp -> Int64 -> Ptr TimeSpec -> Ptr Int64 -> Int64 -> Flow '[ErrorCode] m Int64
...
futexWait :: MonadInIO m => Ptr Int64 -> Int64 -> Maybe TimeSpec -> Flow '[ErrorCode] m ()
...
futexWake :: MonadIO m => Ptr Int64 -> Int64 -> Flow '[ErrorCode] m Int64
...
--
-- Return the number of processes woken up
futexRequeue :: MonadIO m => Ptr Int64 -> Int64 -> Ptr Int64 -> Flow '[ErrorCode] m Int64
...
--
-- Return the number of processes woken up
futexCompareRequeue :: MonadIO m => Ptr Int64 -> Int64 -> Int64 -> Ptr Int64 -> Flow '[ErrorCode] m Int64
