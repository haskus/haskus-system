...
getPropertyMetaM :: MonadInIO m => PropertyMetaID -> Excepts '[InvalidParam, InvalidProperty] (ConfigM m) PropertyMeta
...
-- | Commit atomic state
commitConfig :: MonadInIO m => Atomic -> CommitOrTest -> AsyncMode -> ModesetMode -> Excepts (ObjectNotFound ': AtomicErrors) (ConfigM m) ()
