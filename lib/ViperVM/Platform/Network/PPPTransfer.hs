...
--transferRegion link bufIn regIn bufOut regOut =
--   transferRegionPeer link (bufferPeer bufIn) regIn (bufferPeer bufOut) regOut
--
---- | Perform a synchronous region transfer
--transferRegionPeer :: Network -> BufferPeer -> Region -> BufferPeer -> Region -> IO (Maybe TransferError)
--transferRegionPeer link@(PPPLink {}) bufIn regIn bufOut regOut = do
--   let
